 ...
 * All these classes implement the {@link org.apache.commons.lang3a.concurrent.ConcurrentInitializer} interface which provides just a
 * single method:
 * </p>
 *
 * <pre>
 ...
 * By calling the {@link org.apache.commons.lang3a.concurrent.ConcurrentInitializer#get() get()} method the object managed by the initializer can be obtained.
 * There are different implementations of the interface available
 * addressing various use cases:
 * </p>
 *
 * <p> {@link org.apache.commons.lang3a.concurrent.ConstantInitializer} is a very straightforward implementation of the <code>ConcurrentInitializer</code> interface:
 ...
 * </p>
 *
 * <p>The {@link org.apache.commons.lang3a.concurrent.LazyInitializer} class can be used to defer the creation of an object until it is actually used.
 ...
 * <code>LazyInitializer</code> declares an abstract {@link org.apache.commons.lang3a.concurrent.LazyInitializer#initialize() initialize()} method which we have to implement to create the messaging service object:</p>
 *
 * <pre>
 * <code>
 ...
 * </pre>
 *
 * <p>The {@link org.apache.commons.lang3a.concurrent.AtomicInitializer} class is very similar to <code>LazyInitializer</code>.
 ...
 * Again there is an abstract {@link org.apache.commons.lang3a.concurrent.AtomicInitializer#initialize() initialize()} method which has to be implemented by concrete subclasses in order to create and initialize the managed object.
 ...
 *
 * <p>With {@link org.apache.commons.lang3a.concurrent.AtomicSafeInitializer} there is yet another variant implementing the lazy initializing pattern.
 ...
 * The name &quot;Safe&quot; is derived from the fact that it implements an additional check which guarantees that the {@link org.apache.commons.lang3a.concurrent.AtomicSafeInitializer#initialize() initialize()} method is called only once.
 ...
 *
 * <p>Another implementation of the <code>ConcurrentInitializer</code> interface is {@link org.apache.commons.lang3a.concurrent.BackgroundInitializer}.
 * It is again an abstract base class with an {@link org.apache.commons.lang3a.concurrent.BackgroundInitializer#initialize() initialize()} method that has to be defined by concrete subclasses.
 ...
 * </pre>
 *
 * <p> Related to <code>BackgroundInitializer</code> is the {@link org.apache.commons.lang3a.concurrent.MultiBackgroundInitializer} class.
 ...
 * Then an arbitrary number of <code>BackgroundInitializer</code> objects is added using the {@link org.apache.commons.lang3a.concurrent.MultiBackgroundInitializer#addInitializer(String, BackgroundInitializer)} method.
 * When adding an initializer a string has to be provided which is later used to obtain the result for this initializer.
 * When all initializers have been added the {@link org.apache.commons.lang3a.concurrent.MultiBackgroundInitializer#start()} method is called.
 ...
 * <code>get()</code> returns an object of type {@link org.apache.commons.lang3a.concurrent.MultiBackgroundInitializer.MultiBackgroundInitializerResults}.
 ...
 * There is the {@link org.apache.commons.lang3a.concurrent.ConcurrentUtils} class with a bunch of static utility methods.
 ...
 * </p>
 *
 * <p>The {@link org.apache.commons.lang3a.concurrent.ConcurrentUtils#extractCause(java.util.concurrent.ExecutionException)} method does this work for you.
 ...
 * Otherwise, an instance of {@link org.apache.commons.lang3a.concurrent.ConcurrentException} is created and initialized with the root cause
 ...
 * For users who prefer runtime exceptions in general there is also an {@link org.apache.commons.lang3a.concurrent.ConcurrentUtils#extractCauseUnchecked(java.util.concurrent.ExecutionException)} method which behaves like <code>extractCause()</code>, but returns the unchecked exception {@link org.apache.commons.lang3a.concurrent.ConcurrentRuntimeException} instead.</p>
 *
 * <p>In addition to the <code>extractCause()</code> methods there are corresponding {@link org.apache.commons.lang3a.concurrent.ConcurrentUtils#handleCause(java.util.concurrent.ExecutionException)} and {@link org.apache.commons.lang3a.concurrent.ConcurrentUtils#handleCauseUnchecked(java.util.concurrent.ExecutionException)} methods.
 ...
 *
 * <p> With {@link org.apache.commons.lang3a.concurrent.BasicThreadFactory} Commons Lang has an implementation of <code>ThreadFactory</code> that works out of the box for many common use cases.
 ...
 * Instances of <code>BasicThreadFactory</code> are created and configured using the nested {@link org.apache.commons.lang3a.concurrent.BasicThreadFactory.Builder} class.
 ...
 * An instance can wrap another <code>ThreadFactory</code> implementation; this is achieved by calling the builder's {@link org.apache.commons.lang3a.concurrent.BasicThreadFactory.Builder#wrappedFactory(java.util.concurrent.ThreadFactory) wrappedFactory(ThreadFactory)} method.
 ...
 *
 * <p> {@link org.apache.commons.lang3a.concurrent.TimedSemaphore} allows restricted access to a resource in a given time frame.
 ...
 * Now multiple threads access the semaphore and call its {@link org.apache.commons.lang3a.concurrent.TimedSemaphore#acquire()} method.
 ...
 * </pre>
 *
 * <p>With the {@link org.apache.commons.lang3a.concurrent.TimedSemaphore#setLimit(int)} method the number of permits allowed for a time frame can be changed.
 ...
 */
package org.apache.commons.lang3a.exception.concurrent;
